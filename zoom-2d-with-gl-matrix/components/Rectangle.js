class Rectangle {
  ...
  constructor(gl) {
    ...
    // origin.
    this.setSize(1, 1).setLocation(-0.5, -0.5);
  }
  ...
  setSize(width, height) {
    this.gl.mat2d.fromScaling(
      this.scale,
      this.gl.vec2.fromValues(width, height)
    );
   ...
   */
  setLocation(x, y) {
    this.gl.mat2d.fromTranslation(
      this.translation,
      this.gl.vec2.fromValues(x, y)
    );
